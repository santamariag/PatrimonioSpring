...
@Slf4j
public class CustomDeserializerKeyDTO implements Deserializer<KeyDTO> {
    ...
    @Override
    public KeyDTO deserialize(String topic, byte[] data) {
        try {
            if (data == null){
            ...
            return objectMapper.readValue(new String(data, "UTF-8"), KeyDTO.class);
        } catch (Exception e) {
